...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "olmijoxgmjutyhadmosusnlhqoj7f6acvjwyrpa",
    nc: $.getdata("nc_shareCode1") || "d0c32e7d8f254bfb8e8381098d4b50ba",
    mc: $.getdata("mc_shareCode1") || "MTAxODc2NTEzNDAwMDAwMDAyNjE1NjEzNw==",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5m9cZ2b8iXUfk_Oko0U328U",
    jxgc: $.getdata("jx_shareCode1") || "KkOO0FTUE7DK0TDJMNjvHA==",
  },
  {
